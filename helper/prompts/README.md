...
These four WAV files are temporary English prompts for the SM-T585 live menu test:

- `main-menu.wav`: main menu for keys 1, 2, and 0
- `sales-unavailable.wav`: terminal sales response
