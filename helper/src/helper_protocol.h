...
inline constexpr char kCapabilities[] =
    "runtime=1,2,3,4;recording=1;call_control=2;conversation_recording=1;prompt_barge_in=1;session_audit=1;call_admission=1;capture_receipt=2";
